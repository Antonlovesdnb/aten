...
use fishbowl_collector_linux::network::{self, Endpoint};
use fishbowl_schema::{
...
pub const SOCKET_DIR: &str = "/var/run/fishbowl";
pub const SOCKET_PATH: &str = "/var/run/fishbowl/netflow.sock";
