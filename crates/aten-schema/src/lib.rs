//! ATEN unified event schema (v0.2).
//!
//! These types are the canonical wire format for events emitted by every ATEN
...
/// One aten event. Serializes flat — envelope fields and the per-kind payload
